...
car::car()
{
	m_Texture.loadFromFile(".\\assets\\pictures\\car2.png");
	m_Sprite.setTexture(m_Texture);
	m_fRotationAngle = 0;
	m_Sprite.setOrigin(m_Sprite.getLocalBounds().width / 2.0f, m_Sprite.getLocalBounds().height / 2.0f);
	m_Position = Vector2f(275, 150);
...
{
	// sets the friction
	Vector2f friction(m_Velocity * fCoefficient * fGravity);
	// checks which way is the car going
	...
	m_Accerlation = fSpeed * getRotatVector() * fTimePassed * fDirection - friction;
	// sets the velocity
